package cn.tedu.schoolshop.generator;
...
public class CodeGenerator {
    ...
    // 【请确认】父级别包名称
    public static String parentPackage = "cn.tedu.schoolshop";
    // 【请确认】模块名称，用于组成包名，将和上面的parentPackage组成完整的包名
    public static String modelName = "api.user";
    // 【请确认】数据库连接参数，需要注意数据库名称是否需要修改
    public static String url = "jdbc:mysql://localhost:3306/schoolshop?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    // 连接数据库的驱动类
    public static String driver = "com.mysql.cj.jdbc.Driver";
    // 代码生成的目标路径
    public static String generateTo = "/schoolshop-generator/src/main/java";
    // mapper.xml的生成路径
    public static String mapperXmlPath = "/schoolshop-generator/src/main/resources/mapper";
